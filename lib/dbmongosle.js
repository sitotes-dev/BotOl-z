...
const url = ('mongodb+srv://saiplusitotesdev:<db_password><db_cluster>/?retryWrites=true&w=majority&appName=<db_appName>')
    .replace('<db_cluster>', '@sitotes-cluster.5o7h3.mongodb.net')
    .replace('<db_appName>', 'siTotes-Cluster')
    .replace('<db_password>', 'sitotes01')
